      ...
      <div className="Content" style={{ backgroundColor: PALETTE.primary, color: 'white' }}>
        <Container>
          <Grid container spacing={3}>
            ...
            <Grid container item xs={12} sm={12} md={6} lg={6} xl={6} justify="center" alignItems="center">
              <Box alignItems="center" padding={4} flexGrow={0} display="inline-flex" flexDirection="column" style={{backgroundColor: 'rgba(255,255,255,0.7)', borderRadius: '15px'}}>
                <Typography variant="h4" style={{color: 'black'}} gutterBottom>Digital Presence</Typography>
